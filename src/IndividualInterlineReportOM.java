...
/**
 * show Individual Interline Report for the Office Manager
 */
public class IndividualInterlineReportOM extends JFrame {
    //fields
    ...
    /**
     * holds all the functions to show the Individual Interline Report for Office Manager UI
     */
    public IndividualInterlineReportOM() {
...
//format date for sql. from dd/mm/yyyy to yyyy-mm--dd
        ...
        generateReportButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    FileWriter writer = new FileWriter("Reports\\IndividualInterlineOM "+formattedDateTime+".txt");
                    int numRows = interlineIndividual.getRowCount();
                    int numCols = interlineIndividual.getColumnCount();

                    // Write column names to file
                    for (int col = 0; col < numCols; col++) {
                        String colName = interlineIndividual.getColumnName(col);
                    ...
                    for (int row = 0; row < numRows; row++) {
                        for (int col = 0; col < numCols; col++) {
                            Object value = interlineIndividual.getValueAt(row, col);
