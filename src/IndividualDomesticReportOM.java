            ...
            public void actionPerformed(ActionEvent e) {
                try (
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT ticket_sales.StaffID, Staff.FirstName, ticket_sales.blank_id, ticket_sales.customer, " +
                            ...
                            "FROM ticket_sales LEFT JOIN Staff ON ticket_sales.StaffID = Staff.StaffID WHERE Staff.Role = 'Travel Advisor' AND ticket_sales.report_type = 'Domestic' " +
...
//set text field with correct data for summary report
        ...
        generateReportButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    FileWriter writer = new FileWriter("Reports\\domesticIndividualOM "+formattedDateTime+".txt");
